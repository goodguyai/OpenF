      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 p-12 flex-col justify-between">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Your analysis.
            <br />
            <span className="text-indigo-200">Monetized by AI.</span>
          </h1>
          <p className="text-indigo-200 text-lg max-w-md">
            The platform where fantasy football analysts and sports writers 
            turn their expertise into revenue. Connect your content, reach more fans.
          </p>
        </div>
